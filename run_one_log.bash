...
# EZProxy par EZpaarse et
# EZmesure : il faut deux paramètres
# en entrée : YYYY (année) et MM (mois)
#=====================================

if [[ $# != 2 ]];
then
	echo "Veuillez fournir deux paramètres dans cet ordre : année mois"
	echo "Le mois doit être fourni par son numéro sur deux chiffres."
	echo "Ex. : ./run_one_log.bash 2020 06"
	exit 1
fi
...
ezp bulk $EZPAARSELOGPATH $EZPAARSEANALYSEPATH
if [[ $? != 0 ]];
then
